package com.epam.training.gen.ai.semantic.promt;
...
public class SimplePromptService {
    ...
    public static final String GREETING_MESSAGE = "Please summarize the history of alien cultures in 3 sentences.";
